...
const DBSecretsPageWOC = ({ renderErrorNotification, renderSuccessNotification }) => {
  ...
  return (
    <>
      <PageHeader
        title="DB Secrets"
        description="Securely manage your database credentials across different companies and environments."
      />
...
const DBSecretsPage = withNotification(DBSecretsPageWOC)
export default DBSecretsPage
